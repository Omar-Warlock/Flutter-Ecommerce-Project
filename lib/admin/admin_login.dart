...
TextEditingController usersnamecontr=new TextEditingController();
TextEditingController userspasswordcontr=new TextEditingController();
  @override
     ...
     body:Container(
      child: Stack(children: [
        Container(
          ...
          decoration: BoxDecoration(gradient: LinearGradient(colors: [Color.fromARGB(255, 53, 51, 51),Colors.black],begin: Alignment.topLeft, end: Alignment.bottomRight),borderRadius:BorderRadius.vertical(
              ...
              Material(
                ...
                child:Container(
                  ...
                  child: Column(children: [
                    ...
                    decoration: BoxDecoration(
                      border: Border.all(color: Color.fromARGB(200, 160, 160, 147)),borderRadius: BorderRadius.circular(10)
                    ),
                    child:Center(
                      child: TextFormField(
                        controller:userspasswordcontr ,
                        validator: (value) {
