...
class _AddFoodState extends State<AddFood> {
  ...
  String?value;
  TextEditingController namecotroller=new TextEditingController();
  TextEditingController pricecotroller=new TextEditingController();
  TextEditingController detailscotroller=new TextEditingController();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      leading:GestureDetector(
        ...
        centerTitle: true,
        title: Text("Add Item",style: TextStyle(fontSize: 18.0,fontWeight: FontWeight.bold),),
),
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            ...
            children: [
            Text("UpLoad The Item Picture",style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),
